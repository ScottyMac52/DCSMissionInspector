...
Generated by DCS Mission Reader • {DateTime.Now:yyyy-MM-dd HH:mm}
        ...
        */
        ...
        private static void GenerateKmlExport(string reportDir, string sortie, Table mission)
        {
            ...
            // Coalition-specific color palettes (ABGR format)
            var blueColors = new[] { "ff00ffff", "ff00a5ff", "ff0080ff", "ff0066ff", "ff0040ff" }; // cyan → deep blue
            var redColors = new[] { "ff0000ff", "ff0066ff", "ff00a5ff", "ff0080ff", "ff0040ff" }; // red → orange
            var neutralColors = new[] { "ff00ff80", "ff80ff00", "ffccff00", "ffffff00" };            // green/yellow
